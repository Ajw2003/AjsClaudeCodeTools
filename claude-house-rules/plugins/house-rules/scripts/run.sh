...
#     subagentrules              stdout, exit 0. These exist to make a delegation visible and
#                              re-inject the rules into it, so going quiet here would be the
#                              exact failure they fix.
